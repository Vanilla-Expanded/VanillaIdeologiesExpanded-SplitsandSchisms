...
namespace VIESAS
{
    class VIESASSettings : ModSettings
    {
        ...
        public float thresholdOfColonistCertaintyToTurnToNewIdeology = 0.5f;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref thresholdOfColonistCertaintyToTurnToNewIdeology, "thresholdOfColonistCertaintyToTurnToNewIdeology", 0.5f);
        ...
        public void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listingStandard.SliderLabeled("VIESAS.ThresholdOfColonistCertaintyToTurnToNewIdeology".Translate(), ref thresholdOfColonistCertaintyToTurnToNewIdeology,
                (thresholdOfColonistCertaintyToTurnToNewIdeology * 100f).ToStringDecimalIfSmall() + "%", 0.001f, 1f);
            ...
            if (listingStandard.ButtonText("Reset".Translate()))
            {
                ...
                thresholdOfColonistCertaintyToTurnToNewIdeology = 0.5f;
            }
            listingStandard.End();
